<?php
  ...
  $ConsultaUsuario = "SELECT * FROM padre
    WHERE nombre_padre = '".$username."' AND contrasena_padre ='".$password."'";
  ...
  if (mysqli_num_rows($ResultadoUsuario)>0){
    ...
    $_SESSION['id_usuario']=$Renglon['idPadre'];
    $_SESSION['login']=1;
    header('Location: hijos_padres.php');
  }else{
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="app-brand justify-content-center">
            <a href="hijos_padres.php" class="app-brand-link gap-2">
      ...
      <g id="Icon" transform="translate(27.000000, 15.000000)">
        ...
        <g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
          ...
          <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-5"></use>
              ...
              <span class="app-brand-text demo text-body fw-bolder"> Sistema Escolar</span>
            </a>
          </div>
          <!-- /Logo -->
            ...
            <form id="formAuthentication" class="mb-3" action="login_padres.php" method="POST">
                <div class="mb-3">
