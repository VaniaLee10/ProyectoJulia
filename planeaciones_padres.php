<?php
  ...
  //print_r($ConsultaPadre);

  $ConsultaAlumno = "SELECT `alumno`.*, `materias_has_alumno`.*, `actividades_has_alumno`.* FROM `alumno` 
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
          ...
          <ul class="menu-inner py-1">
            ...
            <?php
                while($RegistroPadre = mysqli_fetch_assoc($ResultadoPadre)){
                    ...
                    echo '<a href="planeaciones_padres.php?idAlumno='.$RegistroPadre['idAlumno'].'" class="menu-link">';
                        echo '<i class="menu-icon tf-icons bx bx-collection"></i>';
                        echo '<div data-i18n="Basic">'.$RegistroPadre['nombre_alumno'].'</div>';
                        echo '</a>';
                    echo '</li>';
                }
            ?>
        ...
        <div class="layout-page">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="login_padres.php">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                <h6 class="text-muted"> Alumno(s)</h6>
                <div class="card mb-4">
                          ...
                          <p><h3>
                            ...
                            <?php
                                if($RegistroAlumno = mysqli_fetch_assoc($ResultadoAlumno)){
                                    ...
                                    echo '</div>';
                                    echo '<div class="mb-3 row">';
                                    echo '<label for="html5-date-input" class="col-md-2 col-form-label">Grupo</label>';
                                    echo '<div class="col-md-3">';
                            ...
                            <br>
              <div class="tab-pane fade show active" id="horizontal-Recursos"  align="right">
                <a href="administrador/pdf/pdfplaneacionespadres.php" class="btn btn-outline-primary">Descargar</a>
             </div>              
            </p>
                        </div>
                              ...
                              <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                  <tr>
                                    <td>07/11/2022 </td>
                                    <td>Español</td>
                                    <td>Libreta de la materia y lapicera</td>
                                    <td>          </td>
              ...
              <div class="tab-pane fade show active" id="horizontal-Recursos"  align="right">
                <a href="administrador/pdf/pdfrecursospadres.php" class="btn btn-outline-primary">Descargar</a>
             </div>
            </p>
        </div>
        ...
        <div class="tab-pane fade" id="navs-top-messages" role="tabpanel">
          <p>
              <h3 class="card-header">Evaluaciones</h3>
              <div class="card-body">
              <?php
                if($RegistroAlumno){
                    echo '<div class="mb-3 row">';
                  ...
                  <div class="col-lg-10  mb-4 mb-xl-0">
                    ...
                    <div class="col-md-8 col-12">
                        <div class="tab-content p-0">
                            ...
                            LEFT JOIN `materias_has_alumno` ON `materias_has_alumno`.`Alumno_idAlumno` = `alumno`.`idAlumno` 
                            LEFT JOIN `actividades_has_alumno` ON `actividades_has_alumno`.`Alumno_idAlumno` = `alumno`.`idAlumno`
                            WHERE alumno.idAlumno = '".$idAlumno."' AND materias_has_alumno.Materia_idMateria = '".$i."'";
    ...
    <div class="row"> -->
            ...
            <!--<footer class="footer bg-light">
              <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
                <div>
                  <a target="_blank" class="footer-text fw-bolder">Sistema Escolar</a> ©
                </div>
                <div>
                  <a href="login_padres.html" class="btn btn-sm btn-outline-danger"><i class="bx bx-log-out-circle"></i> Logout</a>
                </div>
              </div>
            </footer>-->
            <!-- / Footer -->
